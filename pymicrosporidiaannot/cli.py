"""
Command-line interface for the pyMicrosporidiaAnnot pipeline.

Usage
-----
::

    ``pymicrosporidiaannot`` \\
        --input     genome.fasta \\
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="pymicrosporidiaannot",
        description=(
            "pyMicrosporidiaAnnot – microsporidia genome annotation pipeline.\n"
            "Python port of ``pymicrosporidiaannot``.pl."
        ),
    ...
    p.add_argument(
        ...
        help="Root of the pyMicrosporidiaAnnot database tree.",
    )
    p.add_argument(
