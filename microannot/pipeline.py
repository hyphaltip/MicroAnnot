"""
MicroAnnotPipeline – top-level orchestration class.
...
::
    ...
    from microannot import MicroAnnotPipeline

    pipeline = MicroAnnotPipeline(
        input_file   = "genome.fasta",
        db_dir       = "/opt/microannot_db",
...
from microannot.io import preprocess_fasta
from microannot.orf import extract_orfs
from microannot.alignment import (
    annot_alignment,
    annot_alignment_small,
    group_frameshifts,
)
from microannot.trna import run_trnascan, parse_trnascan
from microannot.rrna import run_rrna_blast, parse_rrna_blast
from microannot.glimmer import build_icm, run_glimmer, parse_and_refine_glimmer
from microannot.te import run_te_blast, parse_te_blast
from microannot.interproscan import run_interproscan, parse_interproscan_xml
from microannot.annotate import write_annotations, write_final_annotations


class MicroAnnotPipeline:
    ...
    db_dir:
        Root of the MicroAnnot database tree (must contain ``db_blast/``,
            ...
            for display_id, seq_data in self.annotation.items():
                for orf_id, orf_data in seq_data.items():
                    ...
                    if cds and cds["warning"] == 0:
                        ...
                        from microannot.annotate import _trunc as _t
    ...
    def run(self) -> None:
        ...
        print("MicroAnnot pipeline starting …")
        ...
        print("MicroAnnot pipeline complete.")
