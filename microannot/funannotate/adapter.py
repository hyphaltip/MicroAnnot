"""
Output adapter: convert MicroAnnot GFF3 output to the file layout expected by
...
def convert_to_funannotate(
    ...
    """Convert MicroAnnot output to the funannotate ``predict_results/`` layout.
    ...
    # Collect all GFF features from the MicroAnnot output directory
